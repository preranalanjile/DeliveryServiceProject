            ...
            <div class="putLeft rightBody outerBorder">
                <div id="account" class="serviceContent innerBorder">
                    <form id="form1" runat="server">
                        <!-- Forgot Password -->
                        <div id="RecoverPswd" class="existingAct">
                            <div class="recoverPswd">
                                <div class="innerFormBox">
                                    <span class="textOverBorder blue_text">Recover Password </span>
                                    <!--Recover password request form-->
                                    <div class="blue_text">
                                     <asp:Label ID="ForgotEmailPswd" runat="server" Text="Email Address" width="200" /> 
                                     <asp:TextBox id="ForgotPswdEmail" width="200"  Height="20" AutoPostBack="True" runat="server" />
                                      <!-- Email address required and expression validations -->
                                      <asp:RequiredFieldValidator ID="ReqFotEmail" CssClass="errorMsg" ControlToValidate = "ForgotPswdEmail" Display ="Dynamic" runat="server" ErrorMessage="Please enter email" />
                                      <asp:RegularExpressionValidator id="RegFotEmail" CssClass="errorMsg" ControlToValidate="ForgotPswdEmail" Text="(Invalid email)" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$" runat="server" />
                                     <asp:Button ID="Button2" width="150" Height="25" Text="Recover Password" OnClick="recover_pwd" runat="server" />
                                    </div>
                                    <asp:HyperLink ID="GoBackAccount" NavigateUrl="login.aspx" Text="Go Back to Account Page" runat="server"/> 
                                </div>
                            </div>
                        </div>
                    </form>
