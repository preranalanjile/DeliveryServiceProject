    ...
    <div class="mainDiv">
        ...
        <div>
            ...
            <div class="putLeft rightBody outerBorder">
                <!-- Service Page Start -->
                <div id="service" class="serviceContent innerBorder" >
                        <h1 class="serviceHeader">Services</h1>
                        <p>
                            Texas Delivery Service is geared to meet a variety of challenges that your same day shipping needs might present. We have the knowledge and experience to set up programs to specifically meet or exceed both you and your client's expectations of service, quality and on time dependability. Here are a few of the specialized programs we offer:</p>
                        <div class="deliveryListImg">
                            <ul class="putLeft deliveryList">
                                <li>Grocery Delivery</li>
                                <li>Medical Deliveries</li>
                                <li>Legal Courier Deliveries</li>
                            </ul>
                            <div class="putRight serviceDeliveryImg">
                            </div>
                            <div class="clear">
                            </div>
                        </div>
                        <p class="serviceLastPara">Each type of service is unique in its specific requirements of service and commitment and each is understood by our staff of trained professionals. Our commitment of 24 hour a day reliability to our clients is unsurpassed. Our performance is one you can count on immediately!</p>
