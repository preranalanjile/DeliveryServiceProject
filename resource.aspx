    ...
    <div class="mainDiv">
        ...
        <div>
            ...
            <div class="putLeft rightBody outerBorder">
                ...
                <div id="resource" class="serviceContent innerBorder" >
                        <h1 class="serviceHeader">Resources</h1>
                        <p>Click on a link below to access a form</p>
                            <ul class="form_bill">
                                <li><a href="expressbill.pdf" target="_blank">Express Bill</a></li>
                                <li><a href="cardauthorization.pdf" target="_blank">Card Authorization Form</a></li>
                            </ul>
                </div>
                <!-- Resources Page End -->
            </div>
